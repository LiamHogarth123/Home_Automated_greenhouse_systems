classdef SecondLinkOfGripper < RobotBaseClass
    ...
    methods
%% Constructor
        function self = SecondLinkOfGripper(baseTr,useTool,toolFilename)
            if nargin < 3
...
%             self.model = SerialLink([L1 L2 L3], 'name', 'appendage1');
            self.model = SerialLink([L1 L2 L3], 'name', 'appendage2');
% 
